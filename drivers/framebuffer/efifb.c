...
static int con_setup(struct console *con, char *options)
{
	...
	framebuffer = ioremap_prot(boot_params.screen_info.framebuffer,
	                boot_params.screen_info.framebuffer_size,
	                __pgprot_t(__PAGE_KERNEL | cachemode2protval(_PAGE_CACHE_MODE_UC_MINUS)));
